...
export default function Home() {
  ...
  return (
    ...
    <div className="page">
      ...
      >
        {/* Floating sparkle decorations — 6 pieces */}
        <div style={{ position: 'absolute', top: 8, left: 14, fontSize: '1.6rem', opacity: 0.6, animation: 'float 5.5s ease-in-out infinite' }}>✨</div>
        <div style={{ position: 'absolute', top: 14, right: 18, fontSize: '1.8rem', opacity: 0.6, animation: 'float 6s ease-in-out infinite 1.2s' }}>✨</div>
        <div style={{ position: 'absolute', bottom: 10, right: 30, fontSize: '1.5rem', opacity: 0.6, animation: 'float 5s ease-in-out infinite 2.8s' }}>✨</div>
        ...
        <div style={{ position: 'absolute', top: '45%', right: 55, fontSize: '1.1rem', opacity: 0.6, animation: 'float 7s ease-in-out infinite 3.5s' }}>✨</div>
        <div style={{ position: 'absolute', top: 38, left: '42%', fontSize: '1.3rem', opacity: 0.6, animation: 'float 5.8s ease-in-out infinite 1.8s' }}>✨</div>
